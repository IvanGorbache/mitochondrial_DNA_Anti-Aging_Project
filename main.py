...
def prompt_filter_mode():
    """Prompts the user to select the filtering option via console input 1-3."""
    print("\n" + "=" * 60)
    print("SELECT ALIGNMENT FILTERING CRITERION")
    print("=" * 60)
...
# =====================================================
# SAMPLE ANALYSIS WITH SELECTABLE FILTER MODE
# =====================================================
...
def analyze_sample(reads, reference, kmer_index, k, filter_mode="both"):
    ...
    for read in reads:
        ...
        # Compute Dynamic Programming Levenshtein Edit Distance if candidate segment exists
        ...
        # Evaluate selected filter mode logic
...
def plot_all_data(plot_data, output_dir):
    ...
    # Window 5: Edit Distance Frequency Distribution (Discrete Histogram)
...
# =====================================================
# 2D SCATTER PLOT K-MEANS CLUSTERING
# =====================================================
...
def main():
    ...
    if not use_cache:
        # Prompt user to choose filter mode 1, 2, or 3
        filter_mode = prompt_filter_mode()

        print(f"\nRunning sequence alignment processing with FILTER MODE: '{filter_mode.upper()}'...")
